...
module.exports = {
    ...
    async execute(interaction) {
        ...
        switch (sub) {
            ...
            if (!levelsetup || levelsetup.Disabled === 'disabled') return await interaction.reply({ content: `The **Staff Members have not** set up the **leveling system** yet!`, ephemeral: true});
            ...
            if (!levelsetup1 || levelsetup1.Disabled === 'disabled') return await interaction.reply({ content: `The **Staff Members have not** set up the **leveling system** yet!`, ephemeral: true});
