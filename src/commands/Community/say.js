...
module.exports = {
    ...
    .addStringOption(option => option.setName('message').setDescription('Message provided will be sent as Shipping Manager').setRequired(true).setMaxLength(2000).setMinLength(1))
    .setDescription('Say something as Shipping Manager!.'), 
